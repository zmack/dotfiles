...
if g:NERDCreateDefaultMappings
    call s:CreateMaps('<plug>NERDCommenterComment',    '<space>cc')
    call s:CreateMaps('<plug>NERDCommenterToggle',     '<space><space>')
    call s:CreateMaps('<plug>NERDCommenterMinimal',    '<space>cm')
    call s:CreateMaps('<plug>NERDCommenterSexy',       '<space>cs')
    call s:CreateMaps('<plug>NERDCommenterInvert',     '<space>ci')
    call s:CreateMaps('<plug>NERDCommenterYank',       '<space>cy')
    call s:CreateMaps('<plug>NERDCommenterAlignLeft',  '<space>cl')
    call s:CreateMaps('<plug>NERDCommenterAlignBoth',  '<space>cb')
    call s:CreateMaps('<plug>NERDCommenterNest',       '<space>cn')
    call s:CreateMaps('<plug>NERDCommenterUncomment',  '<space>cu')
    call s:CreateMaps('<plug>NERDCommenterToEOL',      '<space>c$')
    call s:CreateMaps('<plug>NERDCommenterAppend',     '<space>cA')
